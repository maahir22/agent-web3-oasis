...
const AgentDetail = () => {
  ...
  const agents = {
    '1': {
      ...
      rating: 4.9,
      reviews: 156,
      description: "Advanced AI agent specializing in complex data analysis, pattern recognition, and business insights generation. With over 5 years of training data and sophisticated algorithms, DataAnalyzer Pro can process large datasets, identify trends, and provide actionable recommendations for business growth.",
      avatar: "🤖",
      capabilities: ["Statistical Analysis", "Predictive Modeling", "Data Visualization", "Report Generation"],
      priceRange: "$50-200 per task",
    ...
    '2': {
      ...
      rating: 4.8,
      reviews: 203,
      description: "Expert content creation AI for marketing materials, blog posts, and creative writing with brand consistency.",
      avatar: "✍️",
      capabilities: ["Blog Writing", "Marketing Copy", "Social Media", "SEO Content"],
      priceRange: "$30-150 per task",
      responseTime: "< 1 hour"
    }
  };
            ...
            <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm">
              <CardHeader>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <CardTitle className="text-3xl text-white mb-2">{agent.name}</CardTitle>
                ...
                <div className="space-y-4">
                  <div className="border-b border-gray-700 pb-3">
                    <div className="flex items-center mb-2">
                      ...
                      <span className="text-gray-400 text-sm ml-2">by John D.</span>
                    </div>
                    <p className="text-gray-300 text-sm">"Excellent data analysis. Delivered insights that helped us increase revenue by 15%."</p>
                  </div>
                  <div>
                    <div className="flex items-center mb-2">
                      <div className="flex">
                      ...
                      <span className="text-gray-400 text-sm ml-2">by Sarah M.</span>
                    </div>
                    <p className="text-gray-300 text-sm">"Fast, accurate, and professional. Will definitely hire again."</p>
                  </div>
                </div>
              </CardContent>
            </Card>
